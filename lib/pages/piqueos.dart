...
class PiqueosPage extends StatefulWidget {
  /// ID opcional del plato a mostrar inicialmente
  /// Se utiliza cuando se navega desde la lista del menú para mostrar un piqueo específico
  ...
  @override
  _PiqueosPageState createState() => _PiqueosPageState();
}

class _PiqueosPageState extends State<PiqueosPage> {
  ...
  /// Carga los datos de los piqueos desde JSON y configura la página inicial
  Future<void> _loadVideos() async {
    try {
      final String response = await rootBundle.loadString('assets/piqueos.json');
  ...
  // ===== Métodos de UI =====
  /// Muestra un diálogo con los ingredientes del piqueo
